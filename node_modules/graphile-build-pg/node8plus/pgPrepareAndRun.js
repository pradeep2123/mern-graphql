...
const POSTGRAPHILE_PREPARED_STATEMENT_CACHE_SIZE = parseInt(process.env.POSTGRAPHILE_PREPARED_STATEMENT_CACHE_SIZE, 10) || 100;
let lastString;
let lastHash;
...
values) {
  ...
  if (!values || POSTGRAPHILE_PREPARED_STATEMENT_CACHE_SIZE < 1 || !connection || !connection.parsedStatements) {
